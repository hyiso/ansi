...
void main() {
  ...
  test('supports unicode surrogate pairs', () {
    ...
    expect(wrapAnsi('a\uD83C\uDE00bc\uD83C\uDE00d\uD83C\uDE00', 2, hard: true),
        'a\n\uD83C\uDE00\nbc\n\uD83C\uDE00\nd\n\uD83C\uDE00');
  });
  ...
  test(
      '#24, trims leading and trailing whitespace only on actual wrapped lines and only with trimming',
      () {
  ...
  test('covers non-SGR/non-hyperlink ansi escapes', () {
    ...
    expect(wrapAnsi('Hello, \u001B[1D World!', 8, trim: false),
        'Hello, \u001B[1D \nWorld!');
  });
